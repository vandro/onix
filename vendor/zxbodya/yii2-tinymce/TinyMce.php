...
class TinyMce extends InputWidget
{
    ...
    private static $defaultSettings = array(
        ...
        'toolbar'                => "insertfile undo redo | styleselect | bold italic | alignleft aligncenter alignright alignjustify | link image | print preview media | forecolor backcolor | fullscreen",
